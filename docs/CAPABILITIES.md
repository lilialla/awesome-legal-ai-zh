...
**比较口径**：比较中国合同法方法、风险分层、Word 批注/修订交付、脚本和测试。  ·  **大类能力池**：23 项
...
**比较口径**：比较是否适合二次开发、方法结构是否完整、样例和评测是否可复核；不与成熟 DOCX 红线工具直接竞争。  ·  **大类能力池**：23 项
...
**比较口径**：只比较能把审查结果写回 DOCX、保留批注或修订痕迹的项目。  ·  **大类能力池**：23 项
...
**比较口径**：区分合同审查与基于固定模板、事实字段的自动填写。  ·  **大类能力池**：23 项
...
**比较口径**：先按股权转让、融资、并购尽调拆开；首页只给已有明确中国法闸门和交割逻辑的单点项目。  ·  **大类能力池**：20 项
...
**比较口径**：比较尽调清单、材料缺口、风险分级、引证和数据室材料路径。  ·  **大类能力池**：20 项
...
**比较口径**：分别比较轻量 DOCX 脱敏和多格式本地 AI 工作台，重点看材料是否出本机、部署门槛和实测证据。  ·  **大类能力池**：17 项
...
**比较口径**：比较 APK 事实提取、隐私政策一致性、SDK/权限、法规锚定和整改清单；可运行性是当前硬门槛。  ·  **大类能力池**：17 项
...
**比较口径**：比较 DPA 专项角色判断、PIPL/GDPR/跨境隐私条款、材料完整性、签署门禁、输出边界和 benchmark 证据。  ·  **大类能力池**：17 项
...
**比较口径**：比较匿名化事实采集、可识别性判断标准、结论分级、公开来源锚定和可复核自检证据。  ·  **大类能力池**：17 项
...
**比较口径**：比较技术证据提取、交底书结构、查新、本地脱敏和离线测试。  ·  **大类能力池**：9 项
...
**比较口径**：不与专利起草混合，只比较权利要求拆解、侵权比对、稳定性、FTO 和规避设计。  ·  **大类能力池**：9 项
...
**比较口径**：单独比较商标类别规划、可注册性初筛和申请材料准备。  ·  **大类能力池**：9 项
...
**比较口径**：比较源码与说明文档取样、申请表字段、材料排版和本地处理。  ·  **大类能力池**：9 项
...
**比较口径**：单独比较控制权、营业额门槛、相关市场、申报程序和风险输出。  ·  **大类能力池**：9 项
...
**比较口径**：比较 DMCA 证据留存、侵权初筛、法域识别、通知生成、链路封存和真实发送边界。  ·  **大类能力池**：9 项
...
**比较口径**：比较问题分解、法域识别、一手法源、引用可回溯性和面向中国律师的交付。  ·  **大类能力池**：10 项
...
**比较口径**：比较名单覆盖和更新、模糊匹配、误报复核、部署门槛与面向律师的工作流。  ·  **大类能力池**：10 项
...
**比较口径**：要求至少覆盖程序管理、书状、证据、庭审或裁决书工作流，不用域外法检索项目代替。  ·  **大类能力池**：10 项
