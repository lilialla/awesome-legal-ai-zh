...
> 345 个 GitHub 仓库；GitHub 元数据刷新于 2026-08-27T04:35:18Z。完整索引保留同质、轻量、观察和退役项目，不等于推荐清单。
...
|---|---|---|---|---:|---|---|---|---|
| 当前推荐 | 企查查企业核查（当前推荐） | [duhu2000/qcc-agent-cli](https://github.com/duhu2000/qcc-agent-cli) | MCP | 3 | 2026-08-07 | MIT | 测试通过 | 💎企查查智能体数据平台 CLI：工具自省、配置诊断、企业/文档查询命令；本地实测 98 个 Jest 测试通过，需 QCC 授权（MIT）；注意：仓库的“官方产品”表述未独立核验，本索引不对该身份背书 |
| 已索引 | - | [tyc-tech/mcp-skills](https://github.com/tyc-tech/mcp-skills) | 套件 | 19 | 2026-05-06 | 未识别 | 仓库审阅 | 天眼查 MCP Skills；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [duhu2000/vibe-lawyering-qcc](https://github.com/duhu2000/vibe-lawyering-qcc) | 套件 | 6 | 2026-07-29 | MIT | 仓库审阅 | 企查查 MCP 增强版·法律人 AI 工具箱 |
| 已索引 | - | [Ace-Kelly/qcc-mcp-batch](https://github.com/Ace-Kelly/qcc-mcp-batch) | MCP | 4 | 2026-04-27 | MIT | 仓库审阅 | 企查查 MCP 批量抓取（工商/风险/知产 67 字段）；注意：涉及登录态或访问令牌，使用前核验获取方式与平台条款 |
| 关键备选 | 企查查企业核查（关键备选） | [zhanglunet/qcc](https://github.com/zhanglunet/qcc) | 套件 | 2 | 2026-06-10 | Apache-2.0 | 仓库审阅 | 💎企查查 Agent MCP 一站式接入：Python/TypeScript 客户端 + 8 个 workflow skill + 146 tool inventory；需自备 QCC API Key |
...
| 退役 | - | [wgpsec/ENScan_GO](https://github.com/wgpsec/ENScan_GO) | MCP | 0 | 未知 | 未识别 | 仓库审阅 | 💎一键聚合企业工商/控股/对外投资/公众号，支持 MCP；注意：涉及登录态或访问令牌，使用前核验获取方式与平台条款；仓库当前不可访问 |
...
| 已索引 | - | [dgunning/edgartools](https://github.com/dgunning/edgartools) | Skill | 2625 | 2026-08-26 | MIT | 仓库审阅 | SEC 申报分析（10-K/8-K/XBRL/Form 3-4-5） |
| 已索引 | - | [captableinc/captable](https://github.com/captableinc/captable) | 应用 | 820 | 2025-06-04 | AGPL-3.0 | 仓库审阅 | 股权表 + 数据室（Carta/Pulley 替代）；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [LLMQuant/awesome-trading-agents](https://github.com/LLMQuant/awesome-trading-agents) | MCP | 394 | 2026-08-13 | CC0-1.0 | 仓库审阅 | LLM 金融 agent/MCP 清单；注意：涉及登录态或访问令牌，使用前核验获取方式与平台条款 |
| 已索引 | - | [stefanoamorelli/sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp) | MCP | 352 | 2026-08-21 | AGPL-3.0 | 仓库审阅 | SEC EDGAR 的 MCP server |
| 已索引 | - | [SEC-API-io/sec-api-python](https://github.com/SEC-API-io/sec-api-python) | 工具 | 316 | 2026-04-13 | MIT | 仓库审阅 | SEC 数据 SDK（2000万+ 申报、招股书） |
| 已索引 | - | [LLMQuant/skills](https://github.com/LLMQuant/skills) | 套件 | 205 | 2026-05-30 | MIT | 仓库审阅 | 华尔街金融投资 Skills 库（财报/估值/监管） |
| 已索引 | - | [Open-Cap-Table-Coalition/Open-Cap-Format-OCF](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF) | 工具 | 184 | 2026-08-11 | NOASSERTION | 仓库审阅 | 开源股权结构数据标准；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [he-yufeng/ContractGuard](https://github.com/he-yufeng/ContractGuard) | 工具 | 173 | 2026-08-27 | MIT | 仓库审阅 | 中文合同 red flag + 公平度评分（A+~F）；注意：涉及登录态或访问令牌，使用前核验获取方式与平台条款 |
| 已索引 | - | [Ro5s/Startup-Starter-Pack](https://github.com/Ro5s/Startup-Starter-Pack) | 资源 | 116 | 2020-09-30 | 未识别 | 仓库审阅 | ❄️融资范本集（YC SAFE/term sheet/期权，范本不过时）；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 关键备选 | 中国法律尽职调查（关键备选） | [zoharbabin/due-diligence-agents](https://github.com/zoharbabin/due-diligence-agents) | MCP | 93 | 2026-08-08 | Apache-2.0 | 仓库审阅 | 💎M&amp;A 尽调 13 agent（读数据室、交叉引证、定位页码）；注意：发现自动上传或遥测描述，处理客户材料前需复核数据流 |
| 已索引 | - | [Azure-Samples/ally-legal-assistant](https://github.com/Azure-Samples/ally-legal-assistant) | 工具 | 81 | 2025-04-29 | 未识别 | 仓库审阅 | 合同分析/自动批注 Word 插件；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [sboghossian/master-claude-for-legal](https://github.com/sboghossian/master-claude-for-legal) | Skill | 59 | 2026-05-18 | NOASSERTION | 仓库审阅 | M&amp;A 尽调 tabular-review + 多方版本 diff；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [skala-io/legal-skills](https://github.com/skala-io/legal-skills) | 套件 | 47 | 2026-02-10 | Apache-2.0 | 仓库审阅 | 💎Skala（skala.io）创业法 11 skill：SAFE/SAFT/term sheet 审查·Reg S 离岸发行·startup 尽调·辖区选择（Delaware/Cayman/BVI/新加坡） |
...
| 关键备选 | 录用条件与 Offer 比较（关键备选） | [hwu59741-dot/offer-review-cn](https://github.com/hwu59741-dot/offer-review-cn) | Skill | 1 | 2026-09-14 | MIT | 仓库审阅 | 录用通知、劳动合同与附件审阅：检查录用前提、隐藏条件和退出成本，分开比较固定薪酬、浮动奖金、补贴与股权，形成 HR 追问清单。；注意：指令型 Skill，不是独立法律数据库；依赖宿主文件读取、OCR 与联网法源核验，云端宿主可能处理材料。；公开案例和模拟示例属于方法走查，不是盲测或自动化准确率证明；无当前 checks / Release。 |
...
| 已索引 | - | [xiaodingfeng/contract-review](https://github.com/xiaodingfeng/contract-review) | 应用 | 143 | 2026-08-05 | MIT | 仓库审阅 | 合同审查（Vue 全栈） |
...
| 已索引 | - | [ARTHUR-BBU/Agent-T](https://github.com/ARTHUR-BBU/Agent-T) | 应用 | 0 | 2026-09-23 | 未识别 | 仓库审阅 | 采购、租赁与 NDA 签前审查：确定性规则与 AI 观察分离，保留条款原文、证据位置、追问与候选修改建议，支持 Word 报告。；注意：无根 LICENSE / 正式 Release；仅收录公开项目线索，复制、修改、再分发与商用权限需另行确认。；无模型 Key 时运行规则层；启用 AI 后合同文本与问题外传至所选供应商，默认记录 TTL 为 24 小时。认证凭据可同时留空而关闭认证，公网部署须另行配置访问保护。 |
...
| 状态 | 对应任务 | 项目 | 类型 | ★ | 最近更新 | License | 核验 | 一句话定位 / 注意事项 |
|---|---|---|---|---:|---|---|---|---|
| 已索引 | - | [AnttiHero/lavern](https://github.com/AnttiHero/lavern) | MCP | 293 | 2026-07-26 | Apache-2.0 | 仓库审阅 | 💎法律多智能体系统：67 个 specialist/orchestrator agents + 21 个 MCP tools，证据引用、辩论协议、三层校验与 human gate（Apache-2.0） |
| 已索引 | - | [stella/stella](https://github.com/stella/stella) | 套件 | 224 | 2026-08-27 | Apache-2.0 | 仓库审阅 | 💎开源法律 workspace + data stack：案件/文档/Word 编辑、Tabular Review、Legal Atlas、企业登记客户端、匿名化与 stella MCP server（Apache-2.0）；注意：涉及登录态或访问令牌，使用前核验获取方式与平台条款；发现自动上传或遥测描述，处理客户材料前需复核数据流 |
| 关键备选 | 中小律所案件与执业管理（关键备选） | [Lawyer-ray/FachuanHybridSystem](https://github.com/Lawyer-ray/FachuanHybridSystem) | MCP | 211 | 2026-08-25 | NOASSERTION | 仓库审阅 | ⭐💎一线律师自研「法穿 AI Copilot」：法院短信自动解析归档 + 一次生成全套委托材料 + OA/一张网立案 + 本地知识库，Django 6 + React 19 + MCP（127 模型/483 API/35 模块；Elastic 2.0：自用可商用，禁转售为托管服务）；注意：涉及登录态或访问令牌，使用前核验获取方式与平台条款；发现自动上传或遥测描述，处理客户材料前需复核数据流 |
| 已索引 | - | [jlawyerorg/j-lawyer-org](https://github.com/jlawyerorg/j-lawyer-org) | 套件 | 86 | 2026-08-26 | AGPL-3.0 | 仓库审阅 | 德国开源律所管理系统（案件/文档/归档）；注意：涉及登录态或访问令牌，使用前核验获取方式与平台条款 |
| 当前推荐 | 中小律所案件与执业管理（当前推荐） | [lawflow-boop/LawLink](https://github.com/lawflow-boop/LawLink) | 工具 | 86 | 2026-08-17 | MIT | 仓库审阅 | 💎开源自部署中小律所案件与执业管理系统：收案登记、冲突检索、正式案件、持续跟进、财务记录、结案归档、数据导出 |
| 已索引 | - | [leo123-tto/case-board](https://github.com/leo123-tto/case-board) | MCP | 42 | 2026-07-28 | NOASSERTION | 仓库审阅 | 💎律师个人案件可视化看板（macOS 桌面端，Tauri+React；已正式公开源码 v0.3.9，可丢给 AI 自行编译 Windows 版；PolyForm 非商业免费）；注意：涉及登录态或访问令牌，使用前核验获取方式与平台条款；发现自动上传或遥测描述，处理客户材料前需复核数据流 |
...
| 关键备选 | 律师服务投标与采购响应（关键备选） | [kwf18423059038-pixel/sigma-legal-bid-workflow](https://github.com/kwf18423059038-pixel/sigma-legal-bid-workflow) | Skill | 12 | 2026-09-14 | Apache-2.0 | 仓库审阅 | 律师投标与采购响应：采购文件拆解、资格和业绩证据配置、服务方案、响应文件组装、Word 批注、签章密封清单及私有经验库。；注意：Apache-2.0，v1.1.1；当前 GitHub checks FAILURE，requirements-dev.txt 未列出 Pillow，不能描述为开箱即用。；2026-09-24 本机 153 项测试中 152 passed / 1 failed；清洁导入测试的 pdf-redaction 入口未找到提供 pymupdf 的解释器。 |
...
| 关键备选 | AI 内容透明度与标识合规（关键备选） | [Phoeny-Xu/ai-transparency-compliance-skill](https://github.com/Phoeny-Xu/ai-transparency-compliance-skill) | Skill | 2 | 2026-09-22 | 未识别 | Smoke 通过 | 中国大陆、欧盟、加州 AI 内容透明度与标识合规：产品事实问卷、法定角色映射、义务清单、跨法域研究和官方来源复核。；注意：未附统一开源许可证；仅收录公开方法线索，复制、修改、再分发及商用权限需另行确认。；规则库有 90 天复核与高波动监控点；内置文本不等于已核实现行法，实际使用仍须逐项检查适用时点。 |
...
| 已索引 | - | [OpenPipe/pii-redaction](https://github.com/OpenPipe/pii-redaction) | 工具 | 111 | 2025-03-25 | MIT | 仓库审阅 | 数据合规与脱敏相关开源项目；旧版 README 未单独展示，待能力页说明。；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [philterd/phileas](https://github.com/philterd/phileas) | 工具 | 103 | 2026-08-24 | Apache-2.0 | 仓库审阅 | PII/PHI 去标识（HIPAA/GDPR/CCPA） |
| 已索引 | - | [youdianzhineng-ailaw/privacy-policy-self-service-generator-mvp](https://github.com/youdianzhineng-ailaw/privacy-policy-self-service-generator-mvp) | Skill | 15 | 2026-06-02 | NOASSERTION | 仓库审阅 | 💎隐私协议 MVP 生成器（面向 OPC/founder，事实采集→合规校验→生成复查；于泽辉律师·有点智能事务所，已预告 v2/v3）；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
...
| 当前推荐 | 诉讼文书与法律意见书起草（当前推荐） | [fayayy888/legal-document-assistant](https://github.com/fayayy888/legal-document-assistant) | 套件 | 27 | 2026-06-24 | 未识别 | 仓库审阅 | 💎中国法律文书撰写 Skill 套件：答辩状、合同审查、法律意见书、代理前案件分析、案例检索、常法服务等（无 license）；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [katejianglaw/refine-legal-chinese](https://github.com/katejianglaw/refine-legal-chinese) | Skill | 15 | 2026-08-17 | NOASSERTION | 仓库审阅 | 💎「法言法语」法律中文改写/审校：保留事实、立场与法律效果，术语辨析 + 质量清单；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [christyxk-ship-it/chinese-lawyer-case-ocr-skill](https://github.com/christyxk-ship-it/chinese-lawyer-case-ocr-skill) | Skill | 6 | 2026-09-22 | MIT | 仓库审阅 | macOS 中文案卷本地 OCR：扫描 PDF 转可搜索 PDF、逐页 Markdown 和质检报告；按需对疑难页使用 PaddleOCR，保护原件。；注意：2026-09-24 本机 16 项测试中 15 项通过、1 项真实 OCR 基线失败：提取文本夹杂空字符导致关键词匹配失败；原因未完全定位，不标全量通过、不升首页。；完整路线限 macOS Apple Silicon；Intel Mac 仅基础 OCR 路线，首次安装及下载模型需要联网。 |
...
| 状态 | 对应任务 | 项目 | 类型 | ★ | 最近更新 | License | 核验 | 一句话定位 / 注意事项 |
|---|---|---|---|---:|---|---|---|---|
| 关键备选 | 中国法规检索（关键备选） | [ZongziForu/cn-law-hub](https://github.com/ZongziForu/cn-law-hub) | Skill | 62 | 2026-08-19 | NOASSERTION | 测试通过 | 💎中国国家法律法规数据库 Skill：检索、下载、分类与条文查询，浅克隆实测 33 个 unittest 通过（无 license）；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 当前推荐 | 中国法规检索（当前推荐） | [nh59yytyd5-dev/chinalaw-cli](https://github.com/nh59yytyd5-dev/chinalaw-cli) | 套件 | 4 | 2026-08-12 | Apache-2.0 | 测试通过 | 💎中国法律法规本地检索 CLI + MCP：实测内置 49 部基础规范/7516 条条文，支持官方源按需补全、来源元数据和 7 个 Agent Skill |
...
| 关键备选 | 中国案例库检索（关键备选） | [cncases/cases](https://github.com/cncases/cases) | 工具 | 1096 | 2026-08-10 | MPL-2.0 | 仓库审阅 | 💎中国裁判文书本地离线检索 |
| 已索引 | - | [aa0101181514/tw-legal-rag](https://github.com/aa0101181514/tw-legal-rag) | Skill | 300 | 2026-08-25 | NOASSERTION | 仓库审阅 | 台湾法律 RAG；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [billvsme/law_ai](https://github.com/billvsme/law_ai) | 应用 | 235 | 2024-01-22 | 未识别 | 仓库审阅 | ❄️LangChain 法律 RAG（200+ 手册+网搜，给出处）；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [lawchat-oss/mcp-taiwan-legal-db](https://github.com/lawchat-oss/mcp-taiwan-legal-db) | MCP | 176 | 2026-08-24 | MIT | 仓库审阅 | 台湾司法院判决 + 法规 MCP |
...
| 已索引 | - | [Golden2002/legal-research-skill](https://github.com/Golden2002/legal-research-skill) | 套件 | 140 | 2026-04-10 | MIT | 仓库审阅 | 法律检索 skill（劳动/合同/侵权/家事/行政/刑事） |
| 已索引 | - | [JamesANZ/us-legal-mcp](https://github.com/JamesANZ/us-legal-mcp) | MCP | 37 | 2026-04-20 | MIT | 仓库审阅 | 美国立法/判例 MCP |
| 已索引 | - | [agentic-ops/legal-mcp](https://github.com/agentic-ops/legal-mcp) | Skill | 31 | 2026-07-17 | AGPL-3.0 | 仓库审阅 | 法规与案例检索相关开源项目；旧版 README 未单独展示，待能力页说明。 |
| 已索引 | - | [freelawproject/courtlistener-api-client](https://github.com/freelawproject/courtlistener-api-client) | MCP | 28 | 2026-08-15 | BSD-2-Clause | 仓库审阅 | 美国 CourtListener 官方 MCP |
| 已索引 | - | [chouenchieh/china-law](https://github.com/chouenchieh/china-law) | 套件 | 11 | 2026-05-21 | 未识别 | 仓库审阅 | 💎中国法律实务 Claude 插件·45 技能· 集成北大法宝；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 关键备选 | 法规现行性核验（关键备选） | [yuandian-ailaw/yuandian-mcp-server](https://github.com/yuandian-ailaw/yuandian-mcp-server) | 工具 | 4 | 2026-05-22 | MIT | 仓库审阅 | 元典官方 MCP Server ：动态注册法规/案例/企业等开放平台 API，需自备 YUANDIAN API KEY |
...
| 观察 | - | [a1531307144-cell/LexBench](https://github.com/a1531307144-cell/LexBench) | 应用 | 1 | 2026-09-22 | MIT | 仓库审阅 | Windows 个人法研台：导入法律文档、按条切分、BM25 检索、阅读批注与报告导出；v0.8.5 增加预置法规和可选 AI 助手。；注意：API key 以明文存入本机 SQLite；整库备份 ZIP 会包含该配置及原件，应按敏感资料保护，不能将备份直接分享。；AI 功能按用户配置向模型端点发送问题及上下文；不能沿用 README 的笼统“不上传任何服务器”表述。 |
...
| 当前推荐 | 商标申请与可注册性初筛（当前推荐） | [cat-xierluo/trademark-assistant.skill](https://github.com/cat-xierluo/trademark-assistant.skill) | Skill | 5 | 2026-07-28 | NOASSERTION | 仓库审阅 | 商标申请类别规划与可注册性初筛；注意：已被 cat-xierluo/legal-skills 套件收录，独立仓适合单独安装；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
...
| 已索引 | - | [cat-xierluo/code2patent.skill](https://github.com/cat-xierluo/code2patent.skill) | Skill | 3 | 2026-07-05 | NOASSERTION | 仓库审阅 | 代码仓库转发明专利交底材料；注意：已被 cat-xierluo/legal-skills 套件收录，独立仓适合单独安装；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
...
| 状态 | 对应任务 | 项目 | 类型 | ★ | 最近更新 | License | 核验 | 一句话定位 / 注意事项 |
|---|---|---|---|---:|---|---|---|---|
| 关键备选 | 税务与发票技术参考（关键备选） | [openaccountants/openaccountants](https://github.com/openaccountants/openaccountants) | MCP | 348 | 2026-08-26 | AGPL-3.0 | 仓库审阅 | 💎371 个税务 skill 覆盖 134 国（中国可扩展） |
| 关键备选 | 税务与发票技术参考（关键备选） | [fapiaoapi/invoice](https://github.com/fapiaoapi/invoice) | 工具 | 72 | 2026-07-15 | 未识别 | 仓库审阅 | 数电/全电发票 SDK（金税·开票接口）；注意：涉及登录态或访问令牌，使用前核验获取方式与平台条款；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [openbankruptcyproject/bankruptcy-discharge-screener](https://github.com/openbankruptcyproject/bankruptcy-discharge-screener) | 资源 | 1 | 2026-08-23 | MIT | 仓库审阅 | 税务、破产与房地产相关开源项目；旧版 README 未单独展示，待能力页说明。 |
...
| 关键备选 | 破产申报、重整与清算（关键备选） | [f4de01/lawyer-workbench-v3](https://github.com/f4de01/lawyer-workbench-v3) | 套件 | 0 | 2026-09-13 | NOASSERTION | 仓库审阅 | 破产管理人工作台：以 12 模块、72 节点组织材料、指引、模板与办理状态，7 个 Skill 衔接案件建档、DOCX 出件及律师确认。；注意：代码与文档 LICENSE 为 MIT，GitHub 识别 NOASSERTION；随仓第三方官方模板和指引不在 MIT 覆盖范围。；2026-09-24 出件模块 75 项测试：59 passed / 1 failed / 15 skipped；失败为隔离测试进程缺 docx，跳过项涉及本机缺渲染通道，未做全套或真实破产案件验收。 |
...
| 状态 | 对应任务 | 项目 | 类型 | ★ | 最近更新 | License | 核验 | 一句话定位 / 注意事项 |
|---|---|---|---|---:|---|---|---|---|
| 当前推荐 | 大型法律 Skill 库（当前推荐） | [zgbrenner/agentcounsel](https://github.com/zgbrenner/agentcounsel) | 套件 | 17 | 2026-08-05 | MIT | 测试通过 | 💎AI-agnostic 法律团队 skill 库：221 个 skills + matter packs / playbooks / review panels，含 CI、验证脚本与核心 unittest（MIT） |
...
| 关键备选 | 大型法律 Skill 库（关键备选） | [CSlawyer1985/claude-for-legal-ZH](https://github.com/CSlawyer1985/claude-for-legal-ZH) | 套件 | 780 | 2026-08-16 | Apache-2.0 | 仓库审阅 | ⭐官方版的中国法适配 + 元典 MCP，覆盖 12 法域；注意：Fork：上游为 anthropics/claude-for-legal |
| 已索引 | - | [THUYRan/Legal-Skills-Chinese](https://github.com/THUYRan/Legal-Skills-Chinese) | 套件 | 773 | 2026-08-22 | 未识别 | 仓库审阅 | 清华系 38 个律师手验的法律推理 skill（非商用协议）；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 当前推荐 | 中国律师日常套件（当前推荐）<br>专利交底与起草（关键备选） | [cat-xierluo/legal-skills](https://github.com/cat-xierluo/legal-skills) | 套件 | 611 | 2026-08-26 | 未识别 | 仓库审阅 | 杨卫薪律师维护的法律人 Skill 套件：50 个 Skill，覆盖合同、诉讼、检索、知产、文书和个人工作流。；注意：定向实测中同库合同和可视化 10 项通过，听悟转写 4 项因测试与实现签名漂移而报错；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [evolsb/claude-legal-skill](https://github.com/evolsb/claude-legal-skill) | Skill | 419 | 2026-07-23 | MIT | 仓库审阅 | CUAD 风险检测合同审查，兼容 26+ 工具 |
...
| 已索引 | - | [Lawyeah-Tech/lawyeah](https://github.com/Lawyeah-Tech/lawyeah) | 套件 | 1 | 2026-08-25 | Apache-2.0 | 仓库审阅 | 律页公开中国大陆法律技能库：32 个领域/合同包、1998 个原子 Skill，以正负触发、来源状态、字段停止、工作节点和交付合同组织细分律师任务。；注意：本轮只完成结构全检和公司、破产、国资、税务、涉外及合同原子的分层抽样，不能表述为 1998 个原子 Skill 均已验证法律正确；当前提交无公开 CI、自动化测试或 Release，公开仓说明完整评测位于私有边界 |
| 已索引 | - | [Rethymus/LegalHigh](https://github.com/Rethymus/LegalHigh) | 应用 | 0 | 2026-09-24 | 未识别 | 仓库审阅 | 本地优先法律工作台原型：法条与案例检索、引用绑定、事实证据梳理、合同规则审查、文书辅助与只读检索 MCP。；注意：仓库明确未附开源许可证、保留全部权利；公开可读不等于允许复制、修改、分发或商业使用。；AI 默认关闭，启用后会连接配置的模型端点；源码原型仅供本机审阅，不应将开发服务直接暴露公网。 |
...
| 关键备选 | 案件材料整理与双向复核（关键备选） | [yel66026-stack/case-material-organizer](https://github.com/yel66026-stack/case-material-organizer) | Skill | 2 | 2026-09-10 | MIT | 测试通过 | 案件材料只读清点、来源定位、时间轴、主体与金额核对；材料到输出及输出回材料双向复检，成果改动后复检失效。；注意：确定性脚本本地运行；语义整理依赖宿主模型，云端宿主的数据传输政策仍适用。；不内置完整 OCR；图片未识别时须保持待视觉复核，不把材料陈述直接认定为事实。 |
...
| 已索引 | - | [reng599-sys/court-case-digest-generation](https://github.com/reng599-sys/court-case-digest-generation) | Skill | 2 | 2026-08-06 | 未识别 | 仓库审阅 | 裁判文书转人民法院案例库风格案例编写稿 Skill：民事、刑事、行政三版，强调脱敏、案例价值识别、裁判规则提炼、法条案号核验和质量审查。；注意：仓库未提供标准 LICENSE；当前仅低位索引，不标商用；纯 Markdown 指令型 Skill，无自动化测试；法条、案号和案例库引用需人工或 MCP 核验 |
...
| 状态 | 对应任务 | 项目 | 类型 | ★ | 最近更新 | License | 核验 | 一句话定位 / 注意事项 |
|---|---|---|---|---:|---|---|---|---|
| 已索引 | - | [PKU-YuanGroup/ChatLaw](https://github.com/PKU-YuanGroup/ChatLaw) | 模型 | 7588 | 2025-01-04 | AGPL-3.0 | 元数据核验 | ❄️北大袁粒团队，中文法律 LLM 里最出圈的一个；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [pengxiao-song/LaWGPT](https://github.com/pengxiao-song/LaWGPT) | 模型 | 6059 | 2024-06-11 | GPL-3.0 | 元数据核验 | ❄️中文法律知识微调 LLM（法律语料预训练）；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [liuhuanyong/CrimeKgAssitant](https://github.com/liuhuanyong/CrimeKgAssitant) | 数据/评测 | 1584 | 2023-12-05 | 未识别 | 元数据核验 | ❄️罪名预测+法律知识图谱+20w 问答（经典）；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [CSHaitao/LexiLaw](https://github.com/CSHaitao/LexiLaw) | 模型 | 1041 | 2026-03-12 | MIT | 元数据核验 | 清华 THUIR，ChatGLM-6B 基座法律大模型 |
| 已索引 | - | [freelawproject/courtlistener](https://github.com/freelawproject/courtlistener) | 数据/评测 | 1001 | 2026-08-26 | NOASSERTION | 元数据核验 | 美国判例数据库平台；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [AndrewZhe/lawyer-llama](https://github.com/AndrewZhe/lawyer-llama) | 模型 | 1000 | 2024-08-28 | Apache-2.0 | 元数据核验 | ❄️中文法律 LLaMA（律师 llama，经典）；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [jhpyle/docassemble](https://github.com/jhpyle/docassemble) | 数据/评测 | 984 | 2026-08-13 | MIT | 元数据核验 | 💎法律文书自动化老牌平台 |
| 已索引 | - | [FudanDISC/DISC-LawLLM](https://github.com/FudanDISC/DISC-LawLLM) | 模型 | 950 | 2025-05-27 | Apache-2.0 | 元数据核验 | 复旦 DISC 中文法律大模型；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [Liquid-Legal-Institute/Legal-Text-Analytics](https://github.com/Liquid-Legal-Institute/Legal-Text-Analytics) | 数据/评测 | 734 | 2024-11-05 | CC-BY-SA-4.0 | 元数据核验 | ❄️法律文本分析方法库；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [HazyResearch/legalbench](https://github.com/HazyResearch/legalbench) | 数据/评测 | 628 | 2026-03-30 | 未识别 | 元数据核验 | 法律 LLM 评测基准（斯坦福 HazyResearch）；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [zhihaiLLM/wisdomInterrogatory](https://github.com/zhihaiLLM/wisdomInterrogatory) | 模型 | 550 | 2026-04-09 | Apache-2.0 | 元数据核验 | 🔒智海-录问（浙大） |
| 已索引 | - | [open-compass/LawBench](https://github.com/open-compass/LawBench) | 数据/评测 | 448 | 2023-11-13 | Apache-2.0 | 元数据核验 | 💎中文法律能力评测基准（司法部系+多机构，引用最广）；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [neelguha/legal-ml-datasets](https://github.com/neelguha/legal-ml-datasets) | 数据/评测 | 446 | 2026-04-19 | 未识别 | 元数据核验 | 法律 ML 数据集合集；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [freelawproject/eyecite](https://github.com/freelawproject/eyecite) | 数据/评测 | 271 | 2026-08-14 | BSD-2-Clause | 元数据核验 | 💎判例引证解析 |
| 已索引 | - | [thunlp/LegalPLMs](https://github.com/thunlp/LegalPLMs) | 模型 | 196 | 2021-05-09 | 未识别 | 元数据核验 | 清华 Lawformer 等长文书法律预训练模型；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [harveyai/biglaw-bench](https://github.com/harveyai/biglaw-bench) | 数据/评测 | 177 | 2026-03-17 | 未识别 | 元数据核验 | 💎Harvey AI 官方 BigLaw Bench：律所级真实法律任务评测基准（无明确协议，仅参考/引用）；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [Breakend/PileOfLaw](https://github.com/Breakend/PileOfLaw) | 数据/评测 | 150 | 2022-06-30 | 未识别 | 元数据核验 | 数据集、模型与评测相关开源项目；旧版 README 未单独展示，待能力页说明。；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
...
| 已索引 | - | [THUIR/LeCaRDv2](https://github.com/THUIR/LeCaRDv2) | 数据/评测 | 105 | 2024-12-29 | MIT | 元数据核验 | 清华大规模中文法律案例检索数据集 v2；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [MetaGLM/LawGLM](https://github.com/MetaGLM/LawGLM) | 模型 | 101 | 2024-12-10 | Apache-2.0 | 元数据核验 | 数据集、模型与评测相关开源项目；旧版 README 未单独展示，待能力页说明。；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [CSHaitao/LegalOne](https://github.com/CSHaitao/LegalOne) | 模型 | 75 | 2026-02-03 | Apache-2.0 | 元数据核验 | 💎法律推理基座（1.7B/4B/8B） |
...
| 已索引 | - | [SKYLENAGE-AI/PLawBench](https://github.com/SKYLENAGE-AI/PLawBench) | 数据/评测 | 33 | 2026-02-09 | 未识别 | 元数据核验 | 💎法律实务评测基准（Qwen×阿里AIData×晓天衡宇·13 场景 850 题 12500 条 rubric，模拟真实咨询而非考题）；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [YouGram-001/legal-empirical-research-skills](https://github.com/YouGram-001/legal-empirical-research-skills) | 数据/评测 | 15 | 2026-07-14 | GPL-3.0 | 元数据核验 | 💎裁判文书实证研究 Skill 套件：文书转换、清洗去重、字段抽取、标签统一、质量/幻觉抽检，输出回归分析用 CSV；README 写 MIT 但 GitHub 未识别 license |
| 已索引 | - | [THUIR/LegalOne-R1](https://github.com/THUIR/LegalOne-R1) | 模型 | 13 | 2026-01-23 | Apache-2.0 | 元数据核验 | LegalOne-R1 法律推理模型系列发布页（1.7B/4B/8B HF 权重；仓库本体以 README/图表为主，低位收录）；注意：Fork：上游为 CSHaitao/LegalOne |
...
| 状态 | 对应任务 | 项目 | 类型 | ★ | 最近更新 | License | 核验 | 一句话定位 / 注意事项 |
|---|---|---|---|---:|---|---|---|---|
| 已索引 | - | [shawndeng321/hermes-obsidian-legal-cssci-wiki-writing-skills](https://github.com/shawndeng321/hermes-obsidian-legal-cssci-wiki-writing-skills) | 套件 | 3 | 2026-08-14 | 未识别 | 测试通过 | Hermes/Codex 中国法学研究 Skill 包，覆盖 legal-research-wiki、legal-wiki-audit-repair 和 chinese-law-paper-writing，并含更新器、脚本安全测试和 DOCX 脚注工具。；注意：偏法学研究/论文写作和 Obsidian Wiki，不适用于直接生成客户法律意见或诉讼策略；GitHub API 未识别 root license；子技能目录含 MIT LICENSE，但整体复制、修改或分发前仍需按仓库原文核验 |
| 已索引 | - | [kennethkhoocy/legal-scholarship-skills](https://github.com/kennethkhoocy/legal-scholarship-skills) | 套件 | 10 | 2026-08-24 | MIT | Smoke 通过 | 法学研究写作 Skill 套件：覆盖论文规划、文献综述、引用放置、Word/LaTeX 修订、PDF 处理和格式校对，强调预筛文献和外部文献库核验。；注意：定位是法学研究与论文写作工作流，不是律师出具客户法律意见的审查 Skill；引用放置能力依赖用户预筛文献和外部索引核验，不能直接替代人工学术核查 |
| 已索引 | - | [lexchang53/Legal-Pleading-Suite](https://github.com/lexchang53/Legal-Pleading-Suite) | 套件 | 9 | 2026-08-24 | NOASSERTION | Smoke 通过 | 台湾法律实务诉讼书状、法律意见、表格、DOCX/ODT、NotebookLM 和 twlegalrag 引用校验 Skill 套件，含真实 Python 排版与校验脚本。；注意：台湾法域，不适合作为中国大陆法主线工具；根许可证为 CC BY-NC-SA 4.0，禁止按可商用工具宣传或嵌入收费产品/SaaS 前直接复用 |
| 已索引 | - | [Open-Source-Legal/OpenContracts](https://github.com/Open-Source-Legal/OpenContracts) | 资源 | 1452 | 2026-08-26 | MIT | 元数据核验 | 法律资源导航相关开源项目；旧版 README 未单独展示，待能力页说明。 |
| 已索引 | - | [pengxiao-song/awesome-chinese-legal-resources](https://github.com/pengxiao-song/awesome-chinese-legal-resources) | Skill | 1001 | 2023-06-20 | 未识别 | 元数据核验 | 中文法律资源总集；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [lawve-ai/awesome-legal-skills](https://github.com/lawve-ai/awesome-legal-skills) | Skill | 666 | 2026-08-07 | NOASSERTION | 元数据核验 | 法律 Skill 索引；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [thunlp/LegalPapers](https://github.com/thunlp/LegalPapers) | Skill | 499 | 2021-01-22 | 未识别 | 元数据核验 | 清华 NLP；法律智能必读论文；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源；GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [international-explore/awesome-privacy-chinese](https://github.com/international-explore/awesome-privacy-chinese) | Skill | 478 | 2025-01-17 | CC0-1.0 | 元数据核验 | 隐私合规；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [CNIPA/PatentDatabases](https://github.com/CNIPA/PatentDatabases) | 资源 | 436 | 2025-09-30 | GPL-3.0 | 元数据核验 | 个人整理的全球专利数据库 URL 清单（账户名 CNIPA，非官方机构） |
| 已索引 | - | [maastrichtlawtech/awesome-legal-nlp](https://github.com/maastrichtlawtech/awesome-legal-nlp) | Skill | 338 | 2025-10-14 | MIT | 元数据核验 | 国际法律 NLP |
| 已索引 | - | [lawglance/lawglance](https://github.com/lawglance/lawglance) | 资源 | 307 | 2026-08-26 | Apache-2.0 | 元数据核验 | 法律资源导航相关开源项目；旧版 README 未单独展示，待能力页说明。 |
| 已索引 | - | [openlegaldata/awesome-legal-data](https://github.com/openlegaldata/awesome-legal-data) | Skill | 299 | 2026-08-24 | 未识别 | 元数据核验 | 法律文本处理数据集与相关资源导航。；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [Vaquill-AI/awesome-legaltech](https://github.com/Vaquill-AI/awesome-legaltech) | Skill | 208 | 2026-08-06 | 未识别 | 元数据核验 | 全球 LegalTech 开源平台、模型、MCP、数据集与工具导航。；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
| 已索引 | - | [LegalQuants/lq-ai](https://github.com/LegalQuants/lq-ai) | 资源 | 126 | 2026-08-26 | Apache-2.0 | 元数据核验 | 法律资源导航相关开源项目；旧版 README 未单独展示，待能力页说明。 |
...
| 已索引 | - | [SamurAIGPT/AI-Youtube-Shorts-Generator](https://github.com/SamurAIGPT/AI-Youtube-Shorts-Generator) | 资源 | 4738 | 2026-07-29 | 未识别 | 元数据核验 | 长视频切爆款；注意：GitHub 未识别许可证，复制、修改或分发前需另行核验 |
...
| 已索引 | - | [op7418/Claude-to-IM-skill](https://github.com/op7418/Claude-to-IM-skill) | Skill | 2868 | 2026-03-23 | MIT | 元数据核验 | Claude 接 IM 平台 |
| 已索引 | - | [gridaco/grida](https://github.com/gridaco/grida) | 套件 | 2622 | 2026-08-21 | Apache-2.0 | 元数据核验 | Grida Open Design |
| 已索引 | - | [Zleap-AI/SAG](https://github.com/Zleap-AI/SAG) | 数据/评测 | 2425 | 2026-08-25 | MIT | 元数据核验 | 面向 Agent 的增量写入/多跳检索数据底座 |
| 已索引 | - | [op7418/Youtube-clipper-skill](https://github.com/op7418/Youtube-clipper-skill) | Skill | 2158 | 2026-01-22 | MIT | 元数据核验 | YouTube 视频切片 |
...
| 已索引 | - | [kevchentw/awesome-chinese-fonts](https://github.com/kevchentw/awesome-chinese-fonts) | 资源 | 51 | 2016-06-05 | MIT | 元数据核验 | 中文字体清单；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
| 已索引 | - | [xcollantes/free-stock-images-mcp](https://github.com/xcollantes/free-stock-images-mcp) | MCP | 11 | 2025-08-24 | MIT | 元数据核验 | 免费图库 MCP；注意：截至元数据快照已超过一年未更新，保留为历史或基础资源 |
...
| 已索引 | - | [cyontheway/mac-clipboard-to-md](https://github.com/cyontheway/mac-clipboard-to-md) | Skill | 0 | 2026-08-08 | MIT | 元数据核验 | 剪贴板转 MD |
| 已索引 | - | [cyontheway/pdf-watermark-tool](https://github.com/cyontheway/pdf-watermark-tool) | 模型 | 0 | 2026-08-08 | MIT | 元数据核验 | 离线 PDF 水印，纯前端不上传 |
